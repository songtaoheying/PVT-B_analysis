...
def main():
    ...
    # 更新文件路径，添加目录前缀
    raw_data_file = os.path.join(target_dir, 'raw_data.txt')
    cleaned_data_file = os.path.join(target_dir, 'cleaned_data.csv')
    result_file = os.path.join(target_dir, 'result.csv')
